...
K8S_API_CRD_KURYRSECGROUP = K8S_API_CRD + '/kuryrsecuritygroups'
...
K8S_OBJ_SECURITYGROUP = 'KuryrSecurityGroup'
...
K8S_ANNOTATION_X_PROJECT = K8S_ANNOTATION_PREFIX + '-x-project-id'
K8S_ANNOTATION_X_VIF_NAME = K8S_ANNOTATION_PREFIX + '-x-vif-name'
K8S_ANNOTATION_X_ROUTES = K8S_ANNOTATION_PREFIX + '-x-routes'
K8S_ANNOTATION_X_SVC_NAME = K8S_ANNOTATION_PREFIX + '-x-svc-name'
K8S_ANNOTATION_X_SVC_IP = K8S_ANNOTATION_PREFIX + '-x-svc-ip'
K8S_ANNOTATION_X_SUBNET = K8S_ANNOTATION_PREFIX + '-x-subnet-id'
K8S_ANNOTATION_SVC_NAME = K8S_ANNOTATION_PREFIX + '-svc-name'
K8S_ANNOTATION_SVC_IP = K8S_ANNOTATION_PREFIX + '-svc-ip'
K8S_ANNOTATION_SUBNET = K8S_ANNOTATION_PREFIX + '-subnet-id'
K8S_ANNOTATION_SECGROUP = K8S_ANNOTATION_PREFIX + '-security-group-id'
K8S_ANNOTATION_SECGROUP_CRD = K8S_ANNOTATION_PREFIX + '-security-group-crd'
...
K8S_ANNOTATION_SKIP_LBAAS = K8S_ANNOTATION_PREFIX + '-skip-lbaas'
...
SERVICE_X_FINALIZER = 'kuryr.openstack.org/service-x-finalizer'
NETWORKPOLICY_FINALIZER = 'kuryr.openstack.org/networkpolicy-finalizer'
KURYRSECGROUP_FINALIZER = 'kuryr.openstack.org/kuryrsecuritygroup-finalizer'
